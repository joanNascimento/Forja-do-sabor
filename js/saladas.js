document.addEventListener('DOMContentLoaded', function() {
    ...
    // Event listeners para saladas prontas - CORRIGIDO
    saladaProntaRadios.forEach(radio => {
        radio.addEventListener('change', function() {
            if (this.checked) {
                ...
                console.log('Estado atualizado:', pedidoAtual);
    ...
    // Função para atualizar resumo - PRINCIPAL CORREÇÃO AQUI
    function atualizarResumo() {
        ...
        // CORREÇÃO PRINCIPAL: Lógica corrigida para habilitar botão WhatsApp
        if (btnWhatsApp) {
            let pedidoCompleto = false;
            
            // Para saladas prontas, só precisa ter selecionado a salada
            if (pedidoAtual.tipo === 'pronta' && pedidoAtual.saladaPronta) {
                pedidoCompleto = true;
                console.log('Pedido de salada pronta está completo');
            }
            // Para planos, precisa ter todos os campos obrigatórios
            else if (pedidoAtual.tipo === 'plano' && pedidoAtual.plano && 
                     pedidoAtual.base && pedidoAtual.proteina && pedidoAtual.molho) {
                pedidoCompleto = true;
                console.log('Pedido de plano está completo');
            }
            ...
            if (pedidoCompleto) {
                ...
                console.log('Botão WhatsApp habilitado com link:', btnWhatsApp.href);
            } else {
                btnWhatsApp.href = '#';
                btnWhatsApp.style.display = 'none';
                console.log('Botão WhatsApp desabilitado - pedido incompleto');
            }
        }
